		...
		//-----------------------------------------------------------------------Datos Estudio Personal ----------------------------------------------------------------
			...
			public function AltaPersonalAdmin($Personal)
			{
				$Mysql = new MySQLConector();
				$Mysql->Conectar();

				$Consulta ="INSERT INTO Personal (idPersonal,LugarNacimiento_idLugarNacimiento,Domicilio_idDomicilio,Nombre,ApellidoP,ApellidoM,NoEmpleado,CURP,RFC,SS,Departamento,Puesto,FechaIngreso,Horas,TipoSangre,Sexo,EstadoCivil) VALUES (null,'0','0','".$Personal->getNombre()."','".$Personal->getApellidoP()."','".$Personal->getApellidoM()."','".$Personal->getNumeroEmpleado()."','".$Personal->getCURP()."','".$Personal->getRFC()."','".$Personal->getSS()."','".$Personal->getDepartamento()."','".$Personal->getPuesto()."','".$Personal->getFechaIngreso()."','".$Personal->getHoras()."','0','0','0') ";
					...
					while ($fila=$Resultado2->fetch_assoc()){
						...
						$Consulta3 = "INSERT INTO usuarios(idUsuarios,Personal_idPersonal,NombreUsuario,Contrasena) VALUES (NULL,'".$idPer."','".$Personal->getNumeroEmpleado()."','".md5(strtolower($Personal->getApellidoP()))."')";
			...
			public function ModificacionPersonal($Personal)

			{
				$Mysql = new MySQLConector();
				$Mysql->Conectar();

				$Consulta ="UPDATE `personal` SET `Nombre` = '".$Personal->getNombre()."', `ApellidoP` = '".$Personal->getApellidoP()."', `ApellidoM` = '".$Personal->getApellidoM()."', `NoEmpleado` = '".$Personal->getNumeroEmpleado()."', `CURP` = '".$Personal->getCURP()."', `RFC` = '".$Personal->getRFC()."', `SS` = '".$Personal->getSS()."', `Departamento` = '".$Personal->getDepartamento()."', `Puesto` = '".$Personal->getPuesto()."', `FechaIngreso` = '".$Personal->getFechaIngreso->getFechaIngreso()."', `Horas` = '".$Personal->getHoras()."' WHERE `personal`.`idPersonal` = '".$Personal->getidPersonal()."';";
