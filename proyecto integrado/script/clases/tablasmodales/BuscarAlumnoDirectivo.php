                    ...
                    <div class='table table-hover table-bordered'>
                        <table border=1 class='tabla_datos'>
                          ...
                          $salida.="<tr>
                                ...
                                <td><form action='../../formularios/directivos/CrearSesionAlumnoDirectivo.php?idalumno=".$fila['idAlumno']."' method='post'><button class='btn btn-success'>Ver Alumno</button></a></form></td>
                            </tr>";
                            }
