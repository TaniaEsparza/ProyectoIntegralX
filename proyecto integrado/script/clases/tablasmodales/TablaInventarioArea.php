		...
		<div class="col-sm-12">
			...
			<caption>
				...
				if(isset($_SESSION['ConsultaAIA'])){
					$Var = $_SESSION['ConsultaAIA'];
					echo"<a href=\"../../reportes/ArticuloInventarioArea.php?idArea=".$Var."\" target=\"_blank\" ><button class=\"btn btn-success glyphicon glyphicon-pencil\">Generar Reporte</button></a>" ;
				}else{
					$Var = 0;
				}
				?>
