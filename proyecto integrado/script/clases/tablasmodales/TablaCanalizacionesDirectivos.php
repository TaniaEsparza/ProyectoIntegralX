			...
			while($ver=mysqli_fetch_array($Resultado)){ 
				...
				<tbody>
					<tr>
						...
						<?php echo"<td><a href=\"../../reportes/canalizacionD.php?idCanalizacion=".$ver['idCanalizacion']."\" target=\"_blank\"><button class=\"btn btn-success glyphicon glyphicon-pencil\">Mostrar</button></a></td>"?>
					</tr>
					<?php 
				}
				?>
