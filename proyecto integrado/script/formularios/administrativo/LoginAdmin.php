...
if (!isset($_SESSION)) { session_start(); }
   ...
   <div class="container" id="contenedor">
    ...
    <br><center><h2> Inicio de sesión Administrador</h2></center>
    <!--Poner titulo o nombre -->
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
       ...
       if (!isset($_POST['Usuario']) | !isset($_POST['Contrasena'])) {      
        ?>
        <form method="POST" action="LoginAdmin.php" class="form-horizontal">
          <br><br>
        ...
        if ($SQLControlador -> IniciarSesionAdmin($Usuarios)){
          $_SESSION['LoggedinAdmin'] = true;
          $_SESSION['NombreUsuarioAdmin'] = $SQLControlador -> GetNombrePersonal($Usuarios);
          echo "<script language='javascript'>window.location = 'InicioAdmin.php'</script>";
        }else{
