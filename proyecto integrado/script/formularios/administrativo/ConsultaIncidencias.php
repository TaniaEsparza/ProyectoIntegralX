  ...
  <body>
   ...
   <div class="container">
    ...
    <br><center><h2> Tabla Incidencias </h2></center>
    <!--Poner titulo o nombre -->
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
       ...
       <br>
       <div class="col-sm-12" id="buscador"></div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#buscador').load('../../clases/tablasmodales/BuscadorIncidencias.php');
