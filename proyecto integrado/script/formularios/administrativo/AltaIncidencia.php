          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              ...
              <?php if(!isset($_POST['Fecha'])){?>
                <form action="./AltaIncidencia.php" method="POST" onsubmit="return validar()">
                  <form novalidate>
                    <div class="row">
                      <div class="col-md">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xl-4">
                                ...
                                <input type="date" id="Fecha" name="Fecha" class="custom-select">
                                <br>
                              </div>
                            </div>
                              ...
                              <div class="card-body">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-xl-8">
                                    ...
                                    <textarea class="form-control" placeholder="Digite Motivos" rows="2" id="Observaciones" name="Observaciones"></textarea>
                                  </div>
                                </div>
                                <br>
                                <div class="row">
                 ...
                 <?php }else{
                   ...
                   $SQLControlador->AgregarIncidencia($Incidencias);
                 }
                 ?>
               </div>
             </body>
