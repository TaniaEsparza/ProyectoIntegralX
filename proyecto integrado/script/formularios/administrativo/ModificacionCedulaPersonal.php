...
<body>
	...
	<div class="container">
		...
		<br><center><h2> -- Modificación Cédula Básica Personal -- </h2></center>
		<!--Poner titulo o nombre -->
							...
							<div class="card-body">
								...
								<select name="LugarNacimiento" id="LugarNacimiento" class="m-1 custom-select "> 
									...
									while ($fila = $Resultado->fetch_assoc()) { 
										...
										<?php 
										 echo " <option value=\"{$fila['idLugarNacimiento']}\""; if($fila['idLugarNacimiento'] == $idLN) echo "selected"; echo "> {$fila['Municipio']}, {$fila['Localidad']}, {$fila['Estado']}, {$fila['Pais']}</option>";
									}
									?>
								</select>
								<div class="radio">  
