<?php
if (!isset($_SESSION)) { session_start(); $_SESSION['IdUsuarioPersonal'] = 1 ;
}
 ...
 <div class="container" id="contenedor">
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      ...
      <?php 
      /*include '../menus/MenuIzquierdoAlumno.php';*/
      ?>
    ...
    <div class="col-sm-6">
     ...
     if (!isset($_POST['contrasena1']) | !isset($_POST['contrasena2'])) {   
      ...
      $Mysql->Conectar();
      $Consulta = "SELECT * FROM Usuarios WHERE idUsuarios ='".$_SESSION['IdUsuarioPersonal']."';";
      ...
      ?>
      <form method="POST" action="PerfilPersonal.php" class="form-horizontal">
        <br>
        ...
        <div class="col-xs-6">
          <input class="btn btn-success center-block btn-lg" type="submit" name="Inicar" value="Modificar"></input>
        </div>
        <br><br><br>
      </form>
      ...
      if (($ContrasenaOriginal == $Contrasena1) && ($ContrasenaOriginal == $Contrasena2)) {
        ...
        echo "<script language='javascript'>window.location='PerfilPersonal.php'</script>";
      } else if ($Contrasena1 == $Contrasena2) {
        include_once "../../clases/SQLControlador.php";
        include_once "../../clases/Usuarios.php";
        $SQLControlador = new SQLControlador();
        $Usuarios = new Usuarios();
        $Usuarios->setPersonal_idPersonal($_SESSION['IdUsuarioPersonal']);
        $Usuarios->setContrasena($Contrasena1);
        $SQLControlador->ModificarContrasenaPersonal($Usuarios);
      } else {
