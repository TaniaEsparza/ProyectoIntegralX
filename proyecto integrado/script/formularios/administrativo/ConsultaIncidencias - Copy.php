...
<body>
 ...
 <div class="container">
  ...
  <br><center><h2> Filtrado de Incidencias por fecha
   </h2></center>
  <!--Poner titulo o nombre -->
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
     ...
     <br>
     <div id="buscadorD"></div>
     <div id="buscadorI"></div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#tabla').load('../../clases/tablasmodales/TablaIncidencias.php');
    $('#buscadorD').load('../../clases/tablasmodales/BuscadorIncidencias.php');
    $('#buscadorI').load('../../clases/tablasmodales/BuscadorIncidencias.php');
