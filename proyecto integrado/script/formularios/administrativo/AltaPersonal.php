						...
						<div class="card border-success">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-sm-4">
										<b>Nombre(s):</b>
										<input type="text" name="Nombre"  class="form-control" id="Nombre" placeholder=" " onkeypress="return soloLetras(event);" maxlength="25">		
									</div>
									<div class="col-sm-4">
										<b>Apellido Paterno:</b>
										<input type="text" name="ApellidoP" class="form-control" id="ApellidoP" placeholder=" " onkeypress="return soloLetras(event);" maxlength="20">
									</div>
									<div class="col-md-4">
										<b>Apellido Materno:</b>
										<input type="text" name="ApellidoM" class="form-control" id="ApellidoM" placeholder=" " onkeypress="return soloLetras(event);" maxlength="20">
									</div>
								</div>
								<div class="row">
									<div class="col-md-4">
										<b>RFC:</b>
										<input type="text" name="RFC" class="form-control" id="RFC"  placeholder=" " maxlength="13" onKeyUp="this.value = this.value.toUpperCase();" onkeypress="return NumerosLetrasSinCaracteres(event);" >
									</div>
									<div class="col-md-4">
										<b>CURP:</b>
										<input type="text" name="CURP" class="form-control" id="CURP" placeholder=" " maxlength="18" onKeyUp="this.value = this.value.toUpperCase();" onkeypress="return NumerosLetrasSinCaracteres(event);" >
									</div>
									<div class="col-md-4">
										<b>No. IMSS:</b>
										<input type="text" name="IMSS" class="form-control" id="IMSS" placeholder="" maxlength="11" onKeyUp="this.value = this.value.toUpperCase();" onkeypress="return soloNumeros(event);" >
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-4">
										<b>Número Empleado:</b>
										<input type="text" name="NoEmpleado" id="NoEmpleado" class="form-control input-sm" " onkeypress="return soloNumeros(event);">
									</div>
									<div class="col-md-4">
										<b>Fecha de Ingreso:</b>
										<input type="date" name="FechaIngreso" id="FechaIngreso" value="" class="form-control" >
