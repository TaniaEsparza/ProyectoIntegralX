...
<body>
  ...
  <div class="container">
    ...
    <br><center><h2> Modificación Nota / Observación <h2></center>
      <!--Poner titulo o nombre -->
      <br>
      ...
      <div class="row">
        ...
        if(!isset($_POST['Asunto'])){
         ...
         <div class="col-sm-10">
          ...
          <form action="ModificarNotas.php" method="POST" onsubmit="return validar()">
            ...
            $Mysql->Conectar();
            $Consulta = "SELECT alumno.Nombre, alumno.Grupos_idGrupos,alumno.Nombre, alumno.ApellidoP, alumno.ApellidoM , alumno.FechaNac, alumno.Sexo, notas.Asunto, notas.Fecha, notas.Observacion, notas.Alumno_idAlumno FROM alumno INNER JOIN notas ON notas.Alumno_idAlumno = alumno.idAlumno WHERE notas.idNotas ='".$_SESSION['IdAlumnoDirectivoNota'] ."';";

            $Resultado = $Mysql->Consulta($Consulta);
            while ($fila = mysqli_fetch_array($Resultado)){           

              ?>
              <label><b>Fecha:</b></label> <input type="date" id="FechaNota" class="form-control input-sm" value="<?php echo $fila['Fecha'] ?>" name="FechaNota">
            ...
            <label><b>Asunto:</b></label> <input type="text" class="form-control input-sm" id="Asunto" value="<?php echo $fila['Asunto'] ?>" name="Asunto">
            <label><b>Observacion: </b></label>
            <textarea  name="Observacion" id="Observacion" class="form-control input-sm"  onkeypress="return NumerosLetras(event);"><?php echo $fila['Observacion'] ?></textarea>
            <?php }?>
      ...
      <?php } else {
        ...
        $Notas = new Notas();
        $Notas->setidNotas($_SESSION['IdAlumnoDirectivoNota']);
        ...
        $SQLControlador->ModificarNotas($Notas);
      }
      ?>
      <div class="col-sm-1"></div>
    </div>
