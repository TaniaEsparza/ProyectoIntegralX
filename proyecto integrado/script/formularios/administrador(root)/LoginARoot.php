...
if (!isset($_SESSION)) { session_start(); }
   ...
   <div class="container" id="contenedor">
    ...
    <br><center><h2> Inicio de sesión Administrador (Root)</h2></center>
    <!--Poner titulo o nombre -->
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
       ...
       if (!isset($_POST['Usuario']) | !isset($_POST['Contrasena'])) {      
        ?>
        <form method="POST" action="LoginAroot.php" class="form-horizontal">
          <br><br>
        ...
        if ($SQLControlador -> IniciarSesionAroot($Usuarios)){
          $_SESSION['LoggedinARoot'] = true;
          $_SESSION['NombreUsuarioARoot'] = $SQLControlador -> GetNombrePersonal($Usuarios);
          echo "<script language='javascript'>window.location = 'InicioARoot.php'</script>";
        }else{
