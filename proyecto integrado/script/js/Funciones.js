...
function agregarDatosClausula(Numero,Asunto,Motivo,Documentacion){
	...
	$.ajax({
		type:"GET",
		url:"../../clases/tablasmodales/AgregarClausulas.php",
		data:cadena,
		success:function(ad){
			if(ad==1){
				$('#tabla').load('./../../clases/tablasmodales/TablaClausulas.php');
				alert("Clausula agregada correctamente!");
			}else if(ad==4){
				alert("Clausula ya dado de alta");
			}else{
...
function VerClausulas(datos){
	d=datos.split('||');
	$('#idclausula').val(d[0]);
	$('#numerou').val(d[1]);
	$('#asuntou').val(d[2]);
	$('#motivou').val(d[3]);
	$('#documentacionu').val(d[4]);
	$('#estatusu').val(d[5]);
}

function ModificacionClausulas(){
	id=$('#idclausula').val();
	Numero=$('#numerou').val();
	Asunto=$('#asuntou').val();
	Motivo=$('#motivou').val();
	Documentacion=$('#documentacionu').val();
	Estatus=$('#estatusu').val();
	...
	$.ajax({
		type:"GET",
		url:"./../../clases/tablasmodales/ModificarClausula.php",
		data:cadena,
		success:function(r){
			if(r==1){
				$('#tabla').load('./../../clases/tablasmodales/TablaClausulas.php');
				//$('#buscador').load('./../../clases/tablasmodales/BuscadorMateriaGrupoDocente.php');
				alert("Se actualizado la Clausula con éxito!");
			}else{
				alert("Error al actualizar clausula");
			}
...
function agregarConceptosPago(Concepto, Monto, LetraMonto){
	...
	$.ajax({
		type:"GET",
		url:"../../clases/tablasmodales/AgregarConceptosPago.php",
		data:cadena,
		success:function(ad){
			if(ad==1){
				$('#tabla').load('./../../clases/tablasmodales/TablaConceptosPago.php');
				alert("Concepto de pago agregado correctamente!");
			}else if(ad==4){
				alert("Concepto de pago ya dado de alta");
			}else{
				alert("Error al ser Guardado");
			}
		}
...
function VerConceptosPago(datos){
	d=datos.split('||');
	$('#idconcepto').val(d[0]);
	$('#conceptou').val(d[1]);
	$('#montou').val(d[2]);
...
function ModificacionConceptosPago(){
	...
	$.ajax({
		type:"GET",
		url:"./../../clases/tablasmodales/ModificarConceptodePago.php",
		data:cadena,
		success:function(r){
			if(r==1){
				$('#tabla').load('./../../clases/tablasmodales/TablaConceptosPago.php');
				//$('#buscador').load('./../../clases/tablasmodales/BuscadorMateriaGrupoDocente.php');
				alert("Se actualizado el concepto de pago con éxito!");
			}else{
				alert("Error al actualizar concepto de pago");
			}
